...
* 서 있는가는 뒷줄 같은 상품의 z 축과 45° 안, 방향은 뒷줄 같은 상품 기준 ±180° 안(서 있을 때만 보므로 서 있으면
  함께 받습니다), 상자 제자리는 파란 상자가 처음 자리에서 2 cm 넘게 안 밀렸을 때, 다른 상품 그대로는 원래 진열된
  상품이 넘어지거나 15° 넘게 기울거나 5 mm 넘게 밀리지 않았을 때입니다 (2026-09-07). 값은
